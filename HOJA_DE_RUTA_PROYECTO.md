...
- [ ] Completar validación del crosswalk Sec 3A — **310/770 hechas (40%), actualizado 2026-09-08.** Quedan 460. De los intentados en esta pasada, 12 quedaron sin match real ni en INCAP ni en FNDDS (Sazón líquido — la de mayor frecuencia pendiente, 1756 —, Compota, Malagueta, Queso de hoja, y los 8 de la ronda anterior) — vale la pena preguntarle a Daniel si conoce fuente para estos, en vez de seguir buscando a ciegas.
