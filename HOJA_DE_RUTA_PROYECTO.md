...
- [ ] Completar validación del crosswalk Sec 3A — **299/770 hechas (39%), actualizado 2026-09-08.** Quedan 471, de las cuales 8 quedaron marcadas explícitamente como "sin match real en INCAP" (Pan de mantequilla, Dulce de coco, Aceite de maní, 3 jugos de sabores sin entrada propia, "Carne no. 7" sin significado claro, Empanadas mixtas) — necesitan fuente externa (FNDDS) o una decisión de aproximación documentada, no son simples de validar. El resto (288 "media" + 175 "baja" confianza) necesita el mismo tipo de verificación manual que ya se hizo con las 149 "alta" — y esa verificación encontró errores reales incluso en las de "alta confianza" (6 de 149), así que la columna `confianza_sugerencia` no es confiable por sí sola, hay que seguir revisando una por una.
