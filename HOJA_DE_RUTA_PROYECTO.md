...
- [ ] **Hallazgo nuevo — `crosswalk_tablas_composicion.xlsx`, pestaña `Cuest. B Sec 3A`, columna `validado` (M):** 766 filas correctas (TRUE/FALSE), 6 filas con número en vez de booleano — corregir a mano: fila 65 (id 506, "Sal molida refinada") y fila 171 (id 507, "Sal marina") y fila 132 (id 4413, "Sal en grano") → `FALSE`; fila 201 (id 1892, "Alimentos para animales"), fila 676 (id 2936, "Impuesto a vivienda de lujos o suntuarias") y fila 679 (id 2392, "Pulseras de metales preciosos") → `TRUE`. **Ojo:** las filas 676 y 679 no parecen alimentos — revisar si esas filas deberían estar en este crosswalk en absoluto.
